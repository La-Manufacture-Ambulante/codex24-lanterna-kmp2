...
open class TelnetTerminalServer {
    ...
    @Throws(IOException::class)
    constructor(serverSocketFactory: ServerSocketFactory, port: Int, charset: Charset?) {
        this.serverSocket = serverSocketFactory.createServerSocket(port)
        this.charset = charset
    }

    open fun getServerSocket(): ServerSocket {
        return serverSocket
    }

    @Throws(IOException::class)
    open fun acceptConnection(): TelnetTerminal {
