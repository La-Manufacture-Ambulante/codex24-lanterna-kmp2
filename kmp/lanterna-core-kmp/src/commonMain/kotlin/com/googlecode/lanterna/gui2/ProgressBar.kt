...
return String.format(labelFormat, progress * 100.0f)
}
 ...
 * @return Itself
 */
    @Synchronized  fun setMin(min:Int):ProgressBar {
if (min > max)
{
setMax(min)
}
 ...
 * @return Itself
 */
    @Synchronized  fun setMax(max:Int):ProgressBar {
if (max < min)
{
setMin(max)
}
 ...
 * @return Itself
 */
    @Synchronized  fun setValue(value:Int):ProgressBar {
var value = value
if (value < min)
{
value = min
 ...
 * @return Itself
 */
    @Synchronized  fun setLabelFormat(labelFormat:String?):ProgressBar {
...
@Override
protected fun createDefaultRenderer():ComponentRenderer<ProgressBar?>? {
...
@Override
 fun getPreferredSize(component:ProgressBar):TerminalSize {
...
{
return TerminalSize(TerminalTextUtils.getColumnWidth(String.format(component.getLabelFormat(), 100.0f)) + 2, 1)
}
else
{
...
@Override
 fun drawComponent(graphics:TextGUIGraphics, component:ProgressBar?) {
...
{
val character = label!!.charAt(TerminalTextUtils.getStringCharacterIndex(label, column - labelStartPosition))
...
if (preferredWidth > 0)
{
return TerminalSize(preferredWidth, 3)
}
else
{
return TerminalSize(42, 3)
}
}
