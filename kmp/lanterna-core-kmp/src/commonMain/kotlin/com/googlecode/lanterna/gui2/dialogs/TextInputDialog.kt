...
buttonPanel.addComponent(Button(LocalizedString.OK.toString(), ???({ this.onOK() })).setLayoutData(GridLayout.createLayoutData(GridLayout.Alignment.CENTER, GridLayout.Alignment.CENTER, true, false)))
...
@Override
 fun showDialog(textGUI:WindowBasedTextGUI?):String? {
result = null
