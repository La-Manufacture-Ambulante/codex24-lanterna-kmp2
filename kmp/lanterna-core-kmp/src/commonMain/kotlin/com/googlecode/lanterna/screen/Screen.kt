...
@JvmStatic  fun startScreen() 

/**
 * Same as calling [.stopScreen] and then closing the underlying
 * [com.googlecode.lanterna.terminal.Terminal] (where applicable), which will restore things like echo mode,
