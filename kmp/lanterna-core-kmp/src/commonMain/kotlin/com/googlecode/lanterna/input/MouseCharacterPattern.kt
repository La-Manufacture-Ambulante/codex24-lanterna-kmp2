 ...
 */
open class MouseCharacterPattern : CharacterPattern {
    ...
    override fun match(seq: List<Char>): CharacterPattern.Matching? {
        ...
        if (seq[3].hashCode() < 48 || seq[3].hashCode() > 57) {
            return null // nope
        }
        ...
        if (matcher.matches()) {
            ...
            // Get the action
            var actionType =
                if (matcher.group(4).equals("M")) MouseActionType.CLICK_DOWN else MouseActionType.CLICK_RELEASE
