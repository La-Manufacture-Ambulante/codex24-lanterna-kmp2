...
{
when (color) {
BLACK, BLACK_BRIGHT -> return brightBlack
BLUE, BLUE_BRIGHT -> return brightBlue
CYAN, CYAN_BRIGHT -> return brightCyan
DEFAULT -> return if (isForeground) defaultBrightColor else defaultBackgroundColor
GREEN, GREEN_BRIGHT -> return brightGreen
MAGENTA, MAGENTA_BRIGHT -> return brightMagenta
RED, RED_BRIGHT -> return brightRed
WHITE, WHITE_BRIGHT -> return brightWhite
YELLOW, YELLOW_BRIGHT -> return brightYellow
}
}
else
{
when (color) {
BLACK -> return normalBlack
BLACK_BRIGHT -> return brightBlack
BLUE -> return normalBlue
BLUE_BRIGHT -> return brightBlue
CYAN -> return normalCyan
CYAN_BRIGHT -> return brightCyan
DEFAULT -> return if (isForeground) defaultColor else defaultBackgroundColor
GREEN -> return normalGreen
GREEN_BRIGHT -> return brightGreen
MAGENTA -> return normalMagenta
MAGENTA_BRIGHT -> return brightMagenta
RED -> return normalRed
RED_BRIGHT -> return brightRed
WHITE -> return normalWhite
WHITE_BRIGHT -> return brightWhite
YELLOW -> return normalYellow
YELLOW_BRIGHT -> return brightYellow
}
}
...
", brightWhite=" + brightWhite + '}'.toString())
}
