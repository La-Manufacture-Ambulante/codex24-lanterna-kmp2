 ...
 */
     enum class ANSI private constructor(index:Int,  val isBright:Boolean, @get:Override
public override val red:Int, @get:Override
public override val green:Int, @get:Override
...
val fromGreyRamp = fromGreyRamp((red + green + blue) / 3)
 ...
 //Now figure out which one is closest
            val coloredDistance = (((red - fromColorCube.red) * (red - fromColorCube.red)) + 
