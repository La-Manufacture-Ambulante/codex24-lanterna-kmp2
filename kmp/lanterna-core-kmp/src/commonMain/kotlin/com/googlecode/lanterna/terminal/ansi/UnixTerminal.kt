...
terminalCtrlCBehaviour:CtrlCBehaviour?):UnixLikeTTYTerminal(terminalDevice, terminalInput, terminalOutput, terminalCharset, terminalCtrlCBehaviour) {
...
terminalCharset:Charset? = Charset.defaultCharset()) : this(terminalInput, terminalOutput, terminalCharset, CtrlCBehaviour.CTRL_C_KILLS_APPLICATION) {}
...
terminalOutput:OutputStream?, 
terminalCharset:Charset?, 
terminalCtrlCBehaviour:CtrlCBehaviour?) : this(File("/dev/tty"), terminalInput, terminalOutput, terminalCharset, terminalCtrlCBehaviour) {}
}/**
