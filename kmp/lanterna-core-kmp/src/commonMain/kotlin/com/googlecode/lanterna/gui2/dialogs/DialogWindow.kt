 ...
 */
     fun showDialog(textGUI:WindowBasedTextGUI):Object? {
...
private val GLOBAL_DIALOG_HINTS = Collections.unmodifiableSet(HashSet(Collections.singletonList(Hint.MODAL)))
}
}
