 ...
 */
public abstract class DialogWindow protected constructor(title: String?) : AbstractWindow(title) {
     ...
     */
    public open fun showDialog(textGUI: WindowBasedTextGUI): Any? {
    ...
    private companion object {
        private val GLOBAL_DIALOG_HINTS: Set<Hint> =
            Collections.unmodifiableSet(HashSet(Collections.singletonList(Hint.MODAL)))
    }
}
