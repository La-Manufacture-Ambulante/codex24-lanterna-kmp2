 ...
 */
class LanternaThemes private constructor() {
    companion object {
        ...
        @JvmStatic
        fun getRegisteredThemes(): Collection<String> {
            return ArrayList(REGISTERED_THEMES.keys)
        }
        ...
        fun getDefaultTheme(): Theme? {
            return REGISTERED_THEMES["default"]
        }
