...
val themeDefinition = window.getTheme().getDefinition(FatWindowDecorationRenderer::class.java)
...
.withRelativeRows(4)!!
.max(TerminalSize(TerminalTextUtils.getColumnWidth(window!!.getTitle()) + 4, 1))  //Make sure the title fits!
}
else
{
return contentAreaSize!!
