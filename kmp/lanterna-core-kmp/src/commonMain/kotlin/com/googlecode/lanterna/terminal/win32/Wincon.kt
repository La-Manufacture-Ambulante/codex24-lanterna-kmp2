...
interface Wincon : StdCallLibrary, com.sun.jna.platform.win32.Wincon {
    ...
    companion object {
        @JvmField
        val INSTANCE: Wincon =
            Native.load("kernel32", Wincon::class.java, W32APIOptions.UNICODE_OPTIONS) as Wincon

        @JvmField
        val ENABLE_VIRTUAL_TERMINAL_PROCESSING: Int = 0x0004

        @JvmField
        val DISABLE_NEWLINE_AUTO_RETURN: Int = 0x0008
