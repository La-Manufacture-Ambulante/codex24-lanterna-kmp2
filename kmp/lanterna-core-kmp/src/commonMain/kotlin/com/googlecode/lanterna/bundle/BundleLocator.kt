...
abstract class BundleLocator protected constructor(private val bundleName: String?) {
    ...
    private class UTF8Control : ResourceBundle.Control() {
        ...
        override fun newBundle(
            ...
            val streamRef = stream
            if (streamRef != null) {
                try {
                    // Only this line is changed to make it to read properties files as UTF-8.
                    bundle = PropertyResourceBundle(InputStreamReader(streamRef, StandardCharsets.UTF_8))
                } finally {
                    streamRef.close()
                }
            }
    ...
    companion object {
        private val loader: ClassLoader = BundleLocator::class.java.classLoader
    }
}
