...
interface Interactable : Component {
     ...
     * cursor should be hidden. If your component is 5x1 and you want to have the cursor in the middle (when in focus),
     ...
     * component, there are the [Result.MOVE_FOCUS_NEXT], [Result.MOVE_FOCUS_PREVIOUS], [Result.MOVE_FOCUS_LEFT],
     * [Result.MOVE_FOCUS_RIGHT], [Result.MOVE_FOCUS_UP], and [Result.MOVE_FOCUS_DOWN] values. This method should be
     * invoking the input filter, if it is set, to see if the input should be processed or not.
     *
     * Notice that most of the built-in components in Lanterna extend from [AbstractInteractableComponent] which
     ...
     * [setEnabled], this call also does nothing.
     * @return Itself
     */
     ...
     * return `false` if input focus has been disabled through calling [setEnabled].
     ...
     * to handle input. The [AbstractInteractableComponent] implementation always returns `true` here but
    ...
    enum class Result {
         ...
         * instead. This should generally be returned if moving focus by using the left arrow key.
         */
        MOVE_FOCUS_LEFT,
         ...
         * down instead. This should generally be returned if moving focus by using the right arrow key.
         */
        MOVE_FOCUS_RIGHT,
         ...
         * instead. This should generally be returned if moving focus by using the up arrow key.
         */
        MOVE_FOCUS_UP,
         ...
         * instead. This should generally be returned if moving focus by using the down arrow key.
         */
        MOVE_FOCUS_DOWN,
    }
    ...
    enum class FocusChangeDirection {
        /**
         * The next interactable component, going down. This direction usually comes from the user pressing down arrow.
         */
        DOWN,

        /**
         * The next interactable component, going right. This direction usually comes from the user pressing right arrow.
         */
        RIGHT,

        /**
         * The next interactable component, going up. This direction usually comes from the user pressing up arrow.
         */
        UP,

        /**
         * The next interactable component, going left. This direction usually comes from the user pressing left arrow.
         */
        LEFT,
