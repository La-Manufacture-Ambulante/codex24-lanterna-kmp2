...
private val listeners:List<Listener<V?>?>?
 ...
 */
    @Synchronized  fun getRow(index:Int):List<V?>? {
return ArrayList(rows!!.get(index))
}
 ...
 * @return Row from the table as a list of the cell data
 */
    @Synchronized  fun getColumn(index:Int):List<V?>? {
val columnData = ArrayList()
 ...
 */
    @SafeVarargs
@Synchronized  fun addRow(vararg values:V?):TableModel<V?> {
 ...
 * @return Itself
 */
    @Synchronized  fun addRow(values:Collection<V?>?):TableModel<V?> {
 ...
 * @return Itself
 */
    @Synchronized  fun insertRow(index:Int, values:Collection<V?>?):TableModel<V?> {
 ...
 * @return Itself
 */
    @Synchronized  fun removeRow(index:Int):TableModel<V?> {
val removedRow = rows!!.remove(index)
for (listener in listeners!!)
{
 ...
 * @return Itself
 */
    @Synchronized  fun clear():TableModel<V?> {
while (rows!!.size() > 0)
{
removeRow(0)
}
 ...
 */
    @Synchronized  fun getColumnLabel(index:Int):String? {
 ...
 * @return Itself
 */
    @Synchronized  fun setColumnLabel(index:Int, newLabel:String?):TableModel<V?> {
 ...
 * @return Itself
 */
    @Synchronized  fun addColumn(label:String?, newColumnValues:Array<V?>?):TableModel<V?>? {
 ...
 * @return Itself
 */
    @Synchronized  fun insertColumn(index:Int, label:String?, newColumnValues:Array<V?>?):TableModel<V?> {
 ...
 * @return Itself
 */
    @Synchronized  fun removeColumn(index:Int):TableModel<V?> {
val removedColumnHeader = columns!!.remove(index)
val removedColumn = ArrayList()
for (row in rows!!)
{
 ...
 */
    @Synchronized  fun getCell(columnIndex:Int, rowIndex:Int):V? {
 ...
 * @return Itself
 */
    @Synchronized  fun setCell(columnIndex:Int, rowIndex:Int, value:V?):TableModel<V?> {
...
val existingValue = row!!.get(columnIndex)
