...
val sizeMap = IdentityHashMap()
val positionMap = IdentityHashMap()
...
val layoutData = getLayoutData(component!!)
val horizontalSpan = Math.min(layoutData!!.horizontalSpan, actualNumberOfColumns - i)
if (horizontalSpan > 1)
{
var accumWidth = 0
...
val preferredWidth = component!!.getPreferredSize().getColumns()
...
val preferredHeight = component!!.getPreferredSize().getRows()
...
private fun getExpandableColumns(table:Array<Array<Component?>?>):Set<Integer?> {
val expandableColumns = TreeSet()
...
private fun getExpandableRows(table:Array<Array<Component?>?>):Set<Integer?> {
val expandableRows = TreeSet()
var previousComponent:Component? = null
if (table.size > 0)
{
...
private fun grabExtraHorizontalSpace(area:TerminalSize?, columnWidths:IntArray?, expandableColumns:Set<Integer?>, totalWidth:Int):Int {
...
private fun grabExtraVerticalSpace(area:TerminalSize?, rowHeights:IntArray?, expandableRows:Set<Integer?>, totalHeight:Int):Int {
...
val rows = ArrayList()
val hspans = ArrayList()
val vspans = ArrayList()
...
return rows.toArray(arrayOfNulls<Array<Component?>?>(rows.size()))
}
...
return table
 ...
 //Could make this into a Set, but I doubt there will be any real gain in performance as these are probably going
        //to be very small.
        val rowsToRemove = ArrayList()
val columnsToRemove = ArrayList()
...
if (layoutData is GridLayoutData)
{
return layoutData as GridLayoutData?
}
else
{
return DEFAULT
 ...
 */
    @JvmOverloads  fun createLayoutData(
