 ...
 * @author Andreas
 */
 class EscapeSequenceCharacterPattern:CharacterPattern {

/**
 * Map of recognized "standard pattern" sequences:<br></br>
 * e.g.: 24 -&gt; F12 : "Esc [ **24** ~"
 */
    protected val stdMap:Map<Integer?, KeyType?> = HashMap()
/**
 * Map of recognized "finish pattern" sequences:<br></br>
 * e.g.: 'A' -&gt; ArrowUp : "Esc [ **A**"
 */
    protected val finMap:Map<Character?, KeyType?> = HashMap()
/**
...
@Override
 fun match(cur:List<Character?>):Matching? {
...
return if (ks != null) Matching(ks) else null // depends
}
else
{
