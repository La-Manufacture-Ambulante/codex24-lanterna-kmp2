 ...
 * @author Martin
 */
abstract class StreamBasedTerminal @SuppressWarnings("WeakerAccess")
 constructor(private val terminalInput:InputStream?, private val terminalOutput:OutputStream?, terminalCharset:Charset?):AbstractTerminal() {
...
@Override
@Throws(IOException::class)
 fun enquireTerminal(timeout:Int, timeoutTimeUnit:TimeUnit?):ByteArray? {
synchronized (terminalOutput) {
 ...
 */
    private val TERMINAL_SIZE_TIMEOUT = Integer.getInteger("com.googlecode.lanterna.streamTerminalSizeTimeout", 5000)

private val UTF8_REFERENCE = StandardCharsets.UTF_8
}
}
