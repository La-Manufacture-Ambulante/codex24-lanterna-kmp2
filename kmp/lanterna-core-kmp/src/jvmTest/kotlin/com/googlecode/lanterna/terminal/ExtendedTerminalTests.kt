 ...
 */
object ExtendedTerminalTests {
    @Throws(IOException::class, InterruptedException::class)
    fun main(args: Array<String?>?) {
        val extendedTerminal = UnixTerminal()
        extendedTerminal.clearScreen()
        val textGraphics = extendedTerminal.newTextGraphics()
        ...
        textGraphics!!.putString(0, textGraphics!!.size!!.rows - 1, "Will terminate in 3 seconds...", SGR.BLINK)
