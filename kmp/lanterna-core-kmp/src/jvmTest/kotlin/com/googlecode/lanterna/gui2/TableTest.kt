...
override fun applyStyle(table:Table<String?>, cell:String?, columnIndex:Int, rowIndex:Int, isSelected:Boolean, textGUIGraphics:TextGUIGraphics) {
...
.addAction("Row", { val labels = ArrayList<String?>()
...
table.invalidate() })
.addAction("Column", { val labels = ArrayList<String?>()
