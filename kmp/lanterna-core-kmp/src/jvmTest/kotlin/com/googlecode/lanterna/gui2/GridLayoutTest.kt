...
rightGridPanel.addComponent(EmptySpace(TextColor.ANSI.MAGENTA, TerminalSize(4, 2))
.setLayoutData(GridLayout.createLayoutData(GridLayout.Alignment.CENTER, GridLayout.Alignment.BEGINNING, false, true, 1, 4)))
rightGridPanel.addComponent(EmptySpace(TextColor.ANSI.RED, TerminalSize(4, 2))
.setLayoutData(GridLayout.createLayoutData(GridLayout.Alignment.CENTER, GridLayout.Alignment.CENTER, false, true, 1, 4)))
rightGridPanel.addComponent(EmptySpace(TextColor.ANSI.YELLOW, TerminalSize(4, 2))
