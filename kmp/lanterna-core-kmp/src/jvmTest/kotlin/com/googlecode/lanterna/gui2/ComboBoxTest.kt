...
for (item in Arrays.asList("Berlin", "London", "Paris", "Stockholm", "Tokyo"))
{
...
val buttonAddItem = Button("Add", { comboBoxEditable!!.addItem(textBoxNewItem.getText())
...
val buttonSetSelectedIndex = Button("Set Selected Index", { try
{
...
val buttonSetSelectedItem = Button("Set Selected Item", { try
{
