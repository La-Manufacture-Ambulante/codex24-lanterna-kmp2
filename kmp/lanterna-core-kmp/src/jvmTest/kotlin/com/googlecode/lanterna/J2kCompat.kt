...
private fun Any.findMethod(name: String, argCount: Int): Method? {
...
private fun Any.writeMember(name: String, value: Any?) {
...
private fun Any.callMember(name: String, vararg args: Any?): Any? {
...
fun Any.setIntegerProperty(key: Any?, value: Any?) = callMember("setIntegerProperty", key, value)
fun Any.setBooleanProperty(key: Any?, value: Any?) = callMember("setBooleanProperty", key, value)
