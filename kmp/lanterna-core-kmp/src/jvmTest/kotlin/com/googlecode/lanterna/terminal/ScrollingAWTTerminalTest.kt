...
class ScrollingAWTTerminalTest : JFrame() {
    ...
    init {
        ...
        title = "Scrolling AWT Terminal Test"
        ...
        terminalContainer.add(scrollingAwtTerminal, BorderLayout.CENTER)
    ...
    private fun buttonMoveCursorActionPerformed(evt: ActionEvent) {
        val terminalSize = scrollingAwtTerminal.terminalSize ?: return
        val random = Random()
    ...
    private fun printLines(howMany: Int) {
        ...
        repeat(howMany) {
            ...
            repeat(words) {
                ...
                repeat(length) {
                    scrollingAwtTerminal.putCharacter(selection[random.nextInt(selection.length)])
                }
    ...
    companion object {
        ...
        fun main(args: Array<String?>?) {
            try {
                ...
                java.util.logging.Logger.getLogger(ScrollingAWTTerminalTest::class.java.name)
            ...
            java.awt.EventQueue.invokeLater { ScrollingAWTTerminalTest().isVisible = true }
        }
    }
}
