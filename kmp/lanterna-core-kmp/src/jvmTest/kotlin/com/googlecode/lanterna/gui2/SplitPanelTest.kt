...
class SplitPanelTest : TestBase() {
    fun init(textGUI: WindowBasedTextGUI) {
        ...
        // SplitPanel splitH = SplitPanel.ofHorizontal(
        // left.withBorder(Borders.singleLine("left")), right.withBorder(Borders.singleLine("right")));
        ...
        // SplitPanel splitV = SplitPanel.ofVertical(
        // top.withBorder(Borders.singleLine("top")), bottom.withBorder(Borders.singleLine("bottom")));
