...
Panel()
.addComponent(ComboBox<Any?>("Editable", "Item #2", "Item #3", "Item #4", "Item #5", "Item #6", "Item #7")
.setReadOnly(false)
.setPreferredSize(TerminalSize(12, 1)))!!
.addComponent(EmptySpace())!!
.addComponent(ComboBox<Any?>("Read-only", "Item #2", "Item #3", "Item #4", "Item #5", "Item #6", "Item #7")
.setReadOnly(true)
...
val actionsBorder = actionListBox
