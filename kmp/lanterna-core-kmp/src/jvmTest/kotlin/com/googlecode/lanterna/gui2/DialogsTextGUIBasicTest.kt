    ...
    fun main(args: Array<String?>?) {
        ...
        try {
            ...
            dialogsListBox.addItem("Simple TextInputDialog", {
                val result = TextInputDialog.showDialog(textGUI, "TextInputDialog sample", "This is the description", "initialContent")
                System.out.println("Result was: " + result!!)
            })
            dialogsListBox.addItem("Password input", {
                val result = TextInputDialog.showPasswordDialog(textGUI, "Test password input", "This is a password input dialog", "")
                System.out.println("Result was: " + result!!)
            })
